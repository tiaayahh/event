...
BEGIN
    ...
    INSERT INTO expected_tables (table_name) VALUES
        ...
        ('messages'),
        ('attendee_messages'),
        ('attendee_ticket_payments'),
        ('attendee_saved_events'),
    ...
    INSERT INTO expected_columns (table_name, column_name) VALUES
        ...
        ('stall_rentals', 'rental_id'),
        ('stall_rentals', 'event_id'),
        ('stall_rentals', 'vendor_user_id'),
        ('stall_rentals', 'created_by_planner'),
        ('stall_rentals', 'stall_label'),
        ('stall_rentals', 'amount'),
        ('stall_rentals', 'checkout_request_id'),
        ('stall_rentals', 'merchant_request_id'),
        ('stall_rentals', 'phone_number'),
        ('stall_rentals', 'mpesa_code'),
        ('stall_rentals', 'status'),
        ('stall_rentals', 'payment_status'),
        ('stall_rentals', 'created_at'),
        ...
        ('attendee_messages', 'message_id'),
        ('attendee_messages', 'planner_user_id'),
        ('attendee_messages', 'attendee_user_id'),
        ('attendee_messages', 'sender_role'),
        ('attendee_messages', 'message_text'),
        ('attendee_messages', 'message_kind'),
        ('attendee_messages', 'attachment_name'),
        ('attendee_messages', 'attachment_path'),
        ('attendee_messages', 'is_read'),
        ('attendee_messages', 'created_at'),

        ('attendee_ticket_payments', 'payment_id'),
        ('attendee_ticket_payments', 'event_id'),
        ('attendee_ticket_payments', 'attendee_id'),
        ('attendee_ticket_payments', 'checkout_request_id'),
        ('attendee_ticket_payments', 'merchant_request_id'),
        ('attendee_ticket_payments', 'phone_number'),
        ('attendee_ticket_payments', 'mpesa_code'),
        ('attendee_ticket_payments', 'amount'),
        ('attendee_ticket_payments', 'status'),
        ('attendee_ticket_payments', 'created_at'),
        ('attendee_ticket_payments', 'updated_at'),

        ('attendee_saved_events', 'save_id'),
        ('attendee_saved_events', 'attendee_id'),
        ('attendee_saved_events', 'event_id'),
        ('attendee_saved_events', 'created_at'),
